...
class BeeFree implements BeeFreeAdapter {
	...
	//Your API Client ID
	private $_client_id = 'ba3179ff-d3dc-43cf-9389-55527a24c50c';

	//Your API Client Secret
	private $_client_secret = 'TQeZUREjYmhQcrAqOHGQIi2gGOj5cMHvVVWEgPGt7E01lCrodaR';

	//Url to call when authenicating
	private $_auth_url = 'http://web2xmm.com';
